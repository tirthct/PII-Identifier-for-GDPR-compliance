...
image = cv2.imread("resizedImage.jpg")
...
# print('Total found faces are', len(faces_cnn))
j=0
# for face in faces_cnn:
#
#     print("Getting face")
#     print(len(faces_cnn) - j)
#     print("Breaking.")
#     break
#     left = face.rect.left()
#     top = face.rect.top()
